...
from wddetr.nn.modules import *
from wddetr.nn.extra_modules import *
from wddetr.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from wddetr.utils.checks import check_requirements, check_suffix, check_yaml
from wddetr.utils.loss import v8ClassificationLoss, v8DetectionLoss, v8PoseLoss, v8SegmentationLoss
from wddetr.utils.plotting import feature_visualization
from wddetr.utils.torch_utils import (fuse_conv_and_bn, fuse_deconv_and_bn, initialize_weights, intersect_dicts,
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        from wddetr.models.utils.loss import RTDETRDetectionLoss
...
def torch_safe_load(weight):
    from wddetr.utils.downloads import attempt_download_asset
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, Bottleneck,  DWConv,
                 BottleneckCSP, C2f, C3,  nn.Conv2d, nn.ConvTranspose2d,C3x, RepC3,
                 ConvNormLayer):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
